<?php
    ...
    $roll="";
    $issue_date="";
	$query = "select issued_books.book_no,issued_books.book_name,issued_books.book_author,issued_books.roll,
    issued_books.issue_date,users.name from issued_books left join users on issued_books.roll = users.roll";
?>
<!DOCTYPE html>
<html lang="en">
<head>
