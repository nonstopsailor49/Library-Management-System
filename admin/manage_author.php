        ...
        <table class="table table-bordered table-hover">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn" name="edit_author.php"><a href="edit_author.php?aid=<?php echo $row['author_id'];?>">Edit</a></button>
                        <button class="btn" name="delete_author.php"><a href="delete_author.php?aid=<?php echo $row['author_id'];?>">Delete</a></button>
                    </td>
                </tr>
            <?php   }   ?>
        </table>
